    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.weeklyreport.store') }}" aria-label="{{ __('Register') }}">
                        @csrf
                        {{-- 週報情報を取得 --}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="nextweek_schedule" name="nextweek_schedule" rows="5" cols="100" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="thismonth_dayoff" name="thismonth_dayoff" rows="5" cols="100" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="site_information" name="site_information" rows="5" cols="100" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="opinion" name="opinion" rows="5" cols="100" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary btn-lg" name="submit_type" value="save">
                                    {{ __('保存') }}
                                </button>
                                <button type="submit" class="btn btn-success btn-lg" name="submit_type" value="submit">
                                    {{ __('提出') }}
                                </button>
                            </div>
                        </div>
